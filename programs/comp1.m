...
save('results_mix12.mat', 'Results');
    

end

Results.optVal = optVals;
Results(:,[1,2, end,4:4:end])

%%

% upper bounds
utabl = Results(:,[1,2, end,4:4:end]);
